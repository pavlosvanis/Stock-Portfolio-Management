...
This project is a Stock Portfolio Management app that is designed to manage users' stock trading activities. It integrates functionalities such as user authentication, portfolio management, real-time stock data retrieval through api keys, and session handling using Python, MongoDB, and SQLAlchemy.
